			...
			<div className="grid grid-cols-2 mt-[150px] bg-primaryColor">
				<div className="m-auto">
					...
					<div className="mt-[80px]">
						<button className="px-5 py-2 text-black bg-white rounded-md">
							note ページへ
						</button>
					</div>
				</div>
			...
			<div className="flex mt-[50px] justify-evenly items-center">
				...
				<div
					dangerouslySetInnerHTML={{
						__html: `<iframe className='rounded-lg' src="https://www.google.com/maps/d/embed?mid=1WXqpVV81x3-GEBP2vF4UkctoIPtATAU&ehbc=2E312F" width="640" height="400"></iframe>`,
					}}
				></div>
			</div>
