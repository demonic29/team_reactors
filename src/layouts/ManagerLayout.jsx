          ...
          {managerNavs.map((managerNav, index) => (
            <NavLink
              ...
              className={`text-lg px-4 py-2 rounded-lg font-semibold transition-all block hover:bg-primaryColor hover:text-white mb-1  duration-150 ${
                pathname === managerNav.to ? "bg-primaryColor text-white" : ""
              }`}
            >
              {managerNav.name}
            </NavLink>
      ...
      <div className="flex-1">
        <div className="h-[65px] border-b border-b-gray-200 flex items-center justify-between px-4">
          ...
          <div className="flex items-center gap-2">
            <div>
              <div className="text-lg font-semibold text-right">吉丸さん</div>
              <div className="text-gray-500">rekiteku2024@gmail.com</div>
            </div>
            ...
            <button
              ...
              className="bg-slate-100 font-semibold text-primaryColor mx-4 px-4 py-2 rounded-md hover:bg-slate-200"
            >
              ログアウト
            </button>
          </div>
