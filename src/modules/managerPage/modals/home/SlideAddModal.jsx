...
const SlideAddModal = () => {
	...
	const [choosedTour, setChoosedTour] = useState(null);
	return (
		<div className="flex flex-col h-full">
			...
			<div className="h-[300px] shrink-0 aspect-video mx-auto rounded-md relative overflow-hidden group mb-8">
				...
				{bannerImg ? (
					...
					<div className="flex items-center justify-center w-full h-full bg-gray-300"></div>
				)}
			</div>
			<div className="mb-6">
				<ModalFieldTitle>タイトル</ModalFieldTitle>
				<div>
					<ModalInput placeholder="ツアータイトル" />
				</div>
			</div>
			<div className="mb-6">
				<ModalFieldTitle>説明</ModalFieldTitle>
				<div>
					<ModalInput placeholder="ツアー説明" className="" />
				</div>
			</div>
			<div className="mb-6">
