		...
		async function fetchData() {
			...
			try {
				const [
					...
					require(`${API.GET_DATA}?action=getGeneral`),
					require(`${API.GET_DATA}?action=getAbout`),
					require(`${API.GET_DATA}?action=getFooter`),
					require(`${API.GET_DATA}?action=getTour`),
					require(`${API.GET_DATA}?action=getNote`),
