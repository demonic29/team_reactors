        ...
        <div>
            <div className='container'>
                ...
                <CarouselImages slides={
                    tourImg.images && tourImg.images.length > 0 && tourImg.images.map((index,image) => (
                        <img className="rounded-lg h-[300px] w-full object-cover" src={image} alt={index} />
                ...
                <div className='flex justify-center'>
                    <div className='grid gap-10 grid-cols-2 justify-center'>
                        ...
                        {
                            tourImg.images && tourImg.images.length > 0 && tourImg.images.map((image,index) => (
                                <Card
                                    key={index}
                                    title={tourImg.title}
                                    imgSrc={image}
