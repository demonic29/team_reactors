...
const HomePage = () => {
  ...
  useEffect(() => {
    async function fetchImg() {
      try {
        const slideRes = await axios.get('/api/macros/s/AKfycbzOSIFIbV-Ew0bpoGnmsZoQhl4txvxSkZc6ekMywDUvIJ5929eM7GbCXnTZVdtenDXx/exec', {
          params: {
            action: 'getSlide'
          }
        });
        console.log("Response data:", slideRes.data); // Log the response data
