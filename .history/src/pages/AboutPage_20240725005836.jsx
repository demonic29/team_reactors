...
const AboutPage = () => {
  ...
  return (
    <div>
      ...
      {/* main-profile */}
      <div className="grid grid-cols-3 mt-[150px] bg-primaryColor">
        <div className="pl-5 my-auto w-full max-w-[620px] ml-auto pr-16 leading-relaxed">
          ...
          <p
            className="text-xl leading-7 tracking-wider text-slate-100"
            dangerouslySetInnerHTML={{ __html: `${aboutData.owner.introduce}` }}
          ></p>
      ...
      <div className="container flex text-lg mt-[50px] justify-between items-center">
        <div>
          <ul className="grid gap-5">
            <li>会社名（事業名） :{aboutData.access.companyData.name}</li>
            ...
            <li>問い合わせメール : {aboutData.access.contact.email}</li>
          </ul>
        </div>
        <div
